    ...
    <>
      ...
      <section className="py-20 bg-white dark:bg-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg mx-auto text-gray-600 dark:text-gray-300 font-light leading-relaxed">
            <p className="mb-8">
            ...
            <h2 className="text-3xl font-serif text-brand-navy dark:text-white mb-6">Our Story</h2>
            <p className="mb-16">
            ...
            <h2 className="text-3xl font-serif text-brand-navy dark:text-white mb-6">Vision</h2>
            <p className="mb-16">
            ...
            <h2 className="text-3xl font-serif text-brand-navy dark:text-white mb-6">Trained with Care, Served with Consistency</h2>
            <p className="mb-16">
            ...
            <h2 className="text-3xl font-serif text-brand-navy dark:text-white mb-6">What Makes Jaya’s Kitchen Different</h2>
            ...
            <div className="text-center pt-10 border-t border-gray-200 dark:border-white/10">
              <h2 className="text-3xl font-serif text-brand-navy dark:text-white mb-8">Ready to experience Jaya's Kitchen?</h2>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Link to="/menu" className="w-full sm:w-auto bg-brand-navy dark:bg-brand-gold text-white dark:text-black uppercase tracking-widest text-xs font-bold py-4 px-8 transition-all hover:bg-brand-red dark:hover:bg-white text-center">
                  Explore Our Menu
                </Link>
                <Link to="/locations" className="w-full sm:w-auto bg-transparent border-2 border-brand-navy dark:border-brand-gold text-brand-navy dark:text-brand-gold uppercase tracking-widest text-xs font-bold py-4 px-8 transition-all hover:bg-brand-navy hover:text-white dark:hover:bg-brand-gold dark:hover:text-black text-center">
                  Find a Branch Near You
                </Link>
                <a href="https://wa.me/971542779779" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-brand-gold text-brand-navy uppercase tracking-widest text-xs font-bold py-4 px-8 transition-all hover:bg-brand-navy hover:text-white dark:hover:bg-white dark:hover:text-black text-center">
                  Enquire on WhatsApp
                </a>
              </div>
            </div>
